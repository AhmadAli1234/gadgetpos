...
class CashRegisterController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $sell_return_details = $this->cashRegisterUtil->getSellReturnTransactionDetails($business_id, $user_id, $open_time, $close_time);
        $payout = $this->cashRegisterUtil->getSinglePayoutDetails($business_id, $user_id, $open_time, $close_time);
        $payment_types = $this->cashRegisterUtil->payment_types(null, false, $business_id);

        return view('cash_register.register_details')
                    ->with(compact('register_details', 'details', 'payment_types', 'close_time','sell_return_details', 'payout'));
    }
    ...
    public function getRegisterDetails()
    {
        ...
        $payout = $this->cashRegisterUtil->getOpenPayoutDetails($business_id, $user_id, $open_time, $close_time);
    ...
    public function getCloseRegister($id = null)
    {
        ...
        return view('cash_register.close_register_modal')
                    ->with(compact('register_details', 'details', 'payment_types', 'pos_settings','sell_return_details','payout'));
    }
