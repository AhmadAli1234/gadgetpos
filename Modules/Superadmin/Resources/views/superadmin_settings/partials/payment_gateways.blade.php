<div class="pos-tab-content">
    ...
    <div class="row">
        ...
        <h4>Kanoo Pay: <small></small></h4>
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('KANOO_AUTHENTICATIONKEY', 'Authentication KEY:') !!}
                {!! Form::text('KANOO_AUTHENTICATIONKEY', $default_values['KANOO_AUTHENTICATIONKEY'], ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('KANOO_USERID', 'User ID:') !!}
                {!! Form::text('KANOO_USERID', $default_values['KANOO_USERID'], ['class' => 'form-control']); !!}
            </div>
        </div>
