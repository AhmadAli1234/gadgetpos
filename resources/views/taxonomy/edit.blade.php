    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        {!! Form::label('category_image:*') !!}
          {!! Form::file('category_image', ['class' => 'form-control', 'id'=>'category_image']); !!}
      </div>
      <div style='display: flex;'><img src='{{url("public/img/category/".$category->category_image)}}' class='product-thumbnail-small'></div>
      <div class="form-group">
