  ...
  <div class="box box-solid">
    ...
    <input type="hidden" name="sub_type" value="{{$sub_type}}">
      <div class="row">
        ...
        <div class="col-sm-8 col-md-5 col-sm-offset-2">
        ...
        <div class="col-sm-8 col-sm-8 col-sm-offset-2">
          <div class="form-group">
        ...
        <div class="col-sm-8 col-sm-offset-2">
          <button type="submit" class="btn btn-primary">@lang('cash_register.open_register')</button>
        </div>
        @else
