...
<div class="row pos_form_totals" style="background-color: silver; padding: 5px; margin: 0px; border-radius: 10px; width:100%">
	<div class="col-md-12">
		<table class="table table-condensed" style="margin-bottom: -20px;">
			...
			<tr class="pos-small-btns" style="border-top: 1px solid #f4f4f4;">
				<td>
				...
				<td>
				&nbsp;&nbsp;
				<button type="button" class="btn btn-secondary" style="border-radius: 50px; padding: 7px 14px;"><b style="font-size: 17px;"><i class="fas fa-dollar-sign fa-lg"></i></b></button>
