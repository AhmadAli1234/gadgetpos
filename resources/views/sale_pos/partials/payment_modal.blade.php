			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-9 mb-12">
						<a href="Javascript:void(1)" class="col-md-2 btn btn-warning instant-pay" data-amount="1">{{session('business.currency.symbol')}} 1</a>
						<a href="Javascript:void(1)" class="col-md-2 btn btn-warning instant-pay" data-amount="5">{{session('business.currency.symbol')}} 5</a>
						<a href="Javascript:void(1)" class="col-md-2 btn btn-warning instant-pay" data-amount="10">{{session('business.currency.symbol')}} 10</a>
						<a href="Javascript:void(1)" class="col-md-2 btn btn-warning instant-pay" data-amount="20">{{session('business.currency.symbol')}} 20</a>
						<a href="Javascript:void(1)" class="col-md-2 btn btn-warning instant-pay" data-amount="50">{{session('business.currency.symbol')}} 50</a>
						<a href="Javascript:void(1)" class="col-md-2 btn btn-warning instant-pay" data-amount="100">{{session('business.currency.symbol')}} 100</a>
					</div>
					<div class="col-md-9">
						<div class="row">
