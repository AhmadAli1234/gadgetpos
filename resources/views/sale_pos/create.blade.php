	...
	<div class="row mb-12">
		<div class="col-md-12">
			<div class="row">
			    ...
			    if(!empty($pos_settings['show_invoice_scheme']) || !empty($commission_agent)) {
			        $marginTop = "margin-top: -35px";
			    }
			    ?>
				<div class="@if(empty($pos_settings['hide_product_suggestion'])) col-md-6 @else col-md-10 col-md-offset-1 @endif">
					<div class="box box-solid mb-12 formbox" style="padding-bottom:5px;<?php echo $marginTop; ?>;">
						<div class="box-body pb-0" style="padding: 5px 24px;">
