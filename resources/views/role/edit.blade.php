        ...
        <div class="row check_group">
            ...
            <div class="col-md-9">
                ...
                <div class="col-md-12">
                  <div class="checkbox">
                    <label>
                      {!! Form::checkbox('permissions[]', 'access_recent_transcations', in_array('access_recent_transcations', $role_permissions), 
                      [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.access_recent_transcations' ) }}
                    </label>
                  </div>
                </div>
                <div class="col-md-12">
