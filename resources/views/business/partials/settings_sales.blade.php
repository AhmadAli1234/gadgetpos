<div class="pos-tab-content">
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('number_of_invoices', __('Number Of Invoices') . ':') !!} @show_tooltip(__('lang_v1.amount_rounding_method_help'))
               {!! Form::text('invoices', $business->invoices, ['class' => 'form-control']); !!}
            </div>
        </div>
