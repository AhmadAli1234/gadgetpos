...
<div class="row">
	...
	<div class="col-xs-12 text-center">
	    <!-- Invoice  number, Date  -->
		<p style="width: 100% !important;position:relative;top-10px" class="word-wrap">
			<span class=" word-wrap    pull-right text-left">
...
<div class="row">
	<div class="col-xs-12">
		...
		@if(!empty($receipt_details->item_discount_label))
			...
			@endphp
		@endif
		<table class="table table-responsive table-slim" style="border:none !important">
			<thead>
				<tr>
				...
				@forelse($receipt_details->lines as $line)
					<tr>
						<td>
                            ...
                            @if(!empty($line['sub_sku']))<br> {{$line['sub_sku']}}</br> @endif @if(!empty($line['brand'])), {{$line['brand']}} @endif @if(!empty($line['cat_code'])), {{$line['cat_code']}}@endif
...
<div class="row">
	...
	<div class="col-xs-6">
        <div class="table-responsive">
          	<table class="table table-slim border-0">
				<tbody>
...
<div class="row">
    <div class="col-xs-12">
        <?php if(isset($receipt_details->additional_notes) && $receipt_details->additional_notes !="") { ?>
    	<p>Note: {!! nl2br($receipt_details->additional_notes) !!}</p>
    	<?php } ?>
    </div>
</div>
