	...
	<div class="col-md-4">
		<div class="form-group">
			<div class="input-group">
				...
				<input type="hidden" id="ncpy" value="{{$business_details->invoices}}">
				...
				<span class="input-group-btn">
					<button style="margin-left:50px;" type="button" class="btn btn-default bg-white btn-flat add_new_customer" data-name=""  @if(!auth()->user()->can('customer.create')) disabled @endif><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
				</span>
			</div>
		</div>
	</div>
...
<div class="row">
	<div class="col-sm-12 pos_product_div">
		...
		<table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
			<thead>
				<tr>
					<th class="tex-center @if(!empty($pos_settings['inline_service_staff'])) col-md-3 @else col-md-3 @endif">	
					...
					<th class="text-center col-md-1"><b></b><i class="fas fa-times" aria-hidden="true"></i></b></th>
				</tr>
			</thead>
			<tbody id="pos-product-tr"></tbody>
		</table>
	</div>
</div>