...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/findingg','HomeController@findingg');
    ...
    Route::post('payouts/store', 'PayoutController@store');
    ...
    //Route::get('stock-adjustments/receive-inventory/{id}', 'StockAdjustmentController@receiveInventory');
